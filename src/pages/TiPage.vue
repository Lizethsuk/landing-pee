<template>
  <div>
    <HeadePage />
    <ImagePage message="Tecnología de la información" background-image="Landscape-Color.jpg" />
    <DatePage bgColor="#5D6F79" month="abril" day="28"  />
    <CursosPage title="title" lineColor="#5D6F79" bgColor="#7D6247">
      <CursoList
    ...
    <PasosPages colorIcon="green" bgColor="#5D6F79" 
