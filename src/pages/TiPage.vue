<template>
   <div>
    <div>
     <HeadePage />
      <ImagePage especialidad="Tecnologías de Información" :message="myJson.title" :messageSecond="myJson.title2"/>
...
<script>
import json from "../data/TiPage.json";
...
.jumbotron
  background-image url('../assets/areas/ti/banner/kv_005-1.jpg')
